          ...
          <div class="card z-index-0">
            ...
            <div class="row px-xl-5 px-sm-4 px-3">
              ...
              <div class="mt-2 position-relative text-center">
                <p class="text-sm font-weight-bold mb-2 text-secondary text-border d-inline z-index-2 bg-white px-3"> ou </p>
              </div>
            </div>
            <div class="card-body">
              <form role="form" @submit="HandleSubmit">
                ...
                <argon-checkbox checked>
                  <label class="form-check-label" for="flexCheckDefault">J'accepte les <a href="javascript:;" class="text-dark font-weight-bolder">Conditions Générales d'Utilisation</a>
                  </label>
                </argon-checkbox>
