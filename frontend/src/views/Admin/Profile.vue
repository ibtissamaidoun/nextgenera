...
const onSubmit = handleSubmit(async () => {
  try {
    const response = await axiosInstance.put('dashboard-admin/profile/', {
      id: id.value,
...
const updatePassword = async () => {
  try {
    const response = await axiosInstance.put('dashboard-admin/profile/update/password', {
...
const deleteProfile = async () => {
  try {
    const response = await axiosInstance.delete('dashboard-admin/profile/');
